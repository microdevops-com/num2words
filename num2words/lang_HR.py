...
SCALE = {
    ...
    3: ('milijarda', 'milijarde', 'milijardi', True),  # 10^9
    4: ('bilijun', 'bilijuna', 'bilijuna', False),  # 10^12
    5: ('bilijarda', 'bilijarde', 'bilijardi', True),  # 10^15
    6: ('trilijun', 'trilijuna', 'trilijuna', False),  # 10^18
    7: ('trilijarda', 'trilijarde', 'trilijardi', True),  # 10^21
    8: ('kvadrilijun', 'kvadrilijuna', 'kvadrilijuna', False),  # 10^24
    9: ('kvadrilijarda', 'kvadrilijarde', 'kvadrilijardi', True),  # 10^27
